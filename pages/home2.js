...
export default function Home() {
  return (
 <div className='m-4  bg-white shadow-md overflow-hidden '>
    <Head>
        <title>beebroom</title>
  ...
  <div className="container-fluid w-full flex flex-wrap items-center justify-between px-6">
    <div className="container-fluid">
      <a className="flex items-center text-gray-900 hover:text-gray-900 focus:text-gray-900 mt-2 lg:mt-0 mr-1" href="#">
        ...
        <span className="font-medium left-10 relative">About</span>
      </a>
    </div>
  </div>
</nav>
...
{/* <!-- Background image --> */}
   <div
    className="p-12 text-center relative overflow-hidden bg-no-repeat bg-cover bg-banner h-96"
  >
    <div
    ...
    >
      <div className="flex justify-center items-center h-full">
        <div className="text-black">
          <h2 className="font-sans text-5xl mb-4">Reshaping your brand</h2>
          <h4 className="font-sans text-4xl mb-6">web designing | Graphics</h4>
        </div>
      </div>
    </div>
  </div> 
      ...
      <p className='flex flex-col md:flex-row  rounded-lg bg-white shadow-lg ' id="about us">
        Mollit aliquip elit veniam sit Lorem anim velit aute labore aliquip aliquip esse consequat cillum. Dolore ipsum mollit Lorem culpa ex nisi id anim ullamco elit eu. Cillum anim commodo fugiat non nisi. Dolore aliqua magna duis amet deserunt do nulla amet esse incididunt velit. Adipisicing quis eu cillum anim ex exercitation sint et cillum esse consectetur ullamco officia. Fugiat mollit amet ea commodo.
      </p>
      <div id="woork done">
        <div className="">
          <div className="flex flex-col md:flex-row  rounded-lg bg-white shadow-lg ">
            ...
            <div className="p-6 flex flex-col justify-start">
              <p className="text-gray-700 text-base mb-4">
                ...
                little bit longer.
                Laboris reprehenderit duis laboris sint. Amet in Lorem exercitation sint ipsum velit sunt quis duis sunt aute. Pariatur ipsum proident laboris officia ea quis consectetur laborum. Ipsum duis pariatur consectetur reprehenderit elit velit id nulla amet.
              </p>
            </div>
            ...
            <div className="p-6 flex flex-col justify-start">
             ...
             <div className=" w-full  md:h-auto object-cover md:w-48 rounded-t-lg md:rounded-none md:rounded-l-lg bg-banner">
                 .
               </div>
  ...
  <div className="mx-6 py-10 text-center md:text-left">
    <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div className="">
        ...
        <p className="mb-4">
          <a href="#!" className="text-gray-600">Web designing</a>
        </p>
        <p className="mb-4">
          <a href="#!" className="text-gray-600">Graphics</a>
        </p>
        <p className="mb-4">
          <a href="#!" className="text-gray-600">Printing</a>
        </p>
  ...
  <div className="text-center p-6 bg-gray-200">
    ...
    <a className="text-gray-600 font-semibold" href="https://beebroom.com/">BeeBroom</a>
  </div>
</footer>
 </div>
  )
